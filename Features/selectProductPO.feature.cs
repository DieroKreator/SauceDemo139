...
#line hidden
            ...
            else
            {
                this.ScenarioStart();
#line 5
    testRunner.Given("que acesso a página inicial da loja PO", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Dado ");
#line hidden
#line 6
    testRunner.When(string.Format("preencho o {0} PO", usuario), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Quando ");
#line hidden
#line 7
    testRunner.And(string.Format("a {0} e clico no botao login PO", senha), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "E ");
#line hidden
#line 8
    testRunner.Then(string.Format("exibe {0} no titulo da Selecao PO", tituloSecao), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Entao ");
#line hidden
#line 9
    testRunner.When(string.Format("adiciono o {0} ao carrinho PO", produto), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Quando ");
#line hidden
#line 10
    testRunner.And("clico no icone do carrinho de compras PO", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "E ");
#line hidden
#line 11
    testRunner.Then(string.Format("exibe a página do carrinho com a {0} PO", quantidade), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Entao ");
#line hidden
#line 12
    testRunner.And(string.Format("nome do {0} PO", produto), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "E ");
#line hidden
#line 13
